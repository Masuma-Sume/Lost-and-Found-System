...
<body>
    <div class="top-bar">
        ...
        <div class="nav-menu">
            ...
            <a href="#" class="nav-item" id="hotspot-btn" title="View Hotspots">
            ...
            <div class="nav-item report-dropdown" style="position: relative;">
                ...
                <div class="report-dropdown-content" style="display:none;position:absolute;top:110%;left:0;background:white;min-width:180px;box-shadow:0 2px 8px rgba(0,0,0,0.15);border-radius:8px;overflow:hidden;z-index:10;">
                    <a href="report_lost.php" class="user-menu-item" style="color:var(--primary-color);padding:1rem 1.5rem;display:block;text-decoration:none;">Lost Item</a>
                    <a href="report_found.php" class="user-menu-item" style="color:var(--primary-color);padding:1rem 1.5rem;display:block;text-decoration:none;">Found Item</a>
                </div>
            </div>
            ...
            <div class="user-menu">
                ...
                <div class="user-menu-content">
                    ...
                    <a href="report_found.php" class="user-menu-item">
    ...
    <div id="hotspot-modal" class="modal" style="display:none;position:fixed;z-index:2000;left:0;top:0;width:100vw;height:100vh;background:rgba(0,0,0,0.4);align-items:center;justify-content:center;">
        <div class="modal-content" style="background:#fff;border-radius:12px;max-width:400px;width:90%;margin:auto;padding:2rem;box-shadow:0 2px 15px rgba(0,0,0,0.2);position:relative;">
            <span id="close-hotspot" style="position:absolute;top:15px;right:20px;font-size:1.5rem;cursor:pointer;color:#009688;">&times;</span>
            <h2 style="color:#009688;text-align:center;margin-bottom:1.5rem;"><i class="fas fa-fire"></i> Location Hotspots</h2>
            <ol style="padding-left:1.2em;">
                <?php if ($hotspots && $hotspots->num_rows > 0): $rank=1; while($row = $hotspots->fetch_assoc()): ?>
                    <li style="margin-bottom:1em;font-size:1.1em;display:flex;align-items:center;gap:0.7em;">
                        <span style="font-weight:700;color:#00796B;"><?php echo htmlspecialchars($row['Location']); ?></span>
                        <span style="background:#e0f2f1;color:#009688;border-radius:12px;padding:2px 10px;font-size:0.95em;margin-left:auto;">
                            <?php echo $row['count']; ?> items
                        </span>
                    </li>
                <?php $rank++; endwhile; else: ?>
                    <li>No hotspot data available.</li>
                <?php endif; ?>
            </ol>
        </div>
    </div>
